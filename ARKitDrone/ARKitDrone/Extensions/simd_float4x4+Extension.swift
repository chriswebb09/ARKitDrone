...
extension simd_float4x4 {
    ...
    /// Convert to SCNMatrix4 for backwards compatibility
//    public func toSCNMatrix4() -> SCNMatrix4 {
//        return SCNMatrix4(self)
//    }
    
//    /// Initialize from SCNMatrix4
//    public init(_ matrix: SCNMatrix4) {
//        self.init(columns: (
...
//    
    ...
    init(translation: SIMD3<Float>, rotation: simd_quatf, scale: SIMD3<Float>) {
        ...
        let scaleMatrix = float4x4(diagonal: SIMD4<Float>(scale.x, scale.y, scale.z, 1.0))
    ...
    init(translation: SIMD3<Float>, rotation: simd_quatf, uniformScale: Float) {
        self.init(translation: translation, rotation: rotation, scale: SIMD3<Float>(uniformScale, uniformScale, uniformScale))
    }
