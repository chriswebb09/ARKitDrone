...
extension simd_quatf {
    ...
    static func getQuaternion(from angleConversion: (Float, Float, Float, Float)) -> simd_quatf {
        return simd_quatf(ix: angleConversion.0, iy: angleConversion.1, iz: angleConversion.2, r: angleConversion.3)
    }
    ...
    init(axis: SIMD3<Float>, angle: Float) {
        ...
        self.init(ix: normalizedAxis.x * s, iy: normalizedAxis.y * s, iz: normalizedAxis.z * s, r: cos(halfAngle))
    }
